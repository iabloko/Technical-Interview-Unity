...
- жёсткие ссылки (`FindObjectOfType`, прямые поля) → хрупкий граф зависимостей.
...
- Что такое coupling и cohesion и какое их сочетание целевое.
- Чем плохи `FindObjectOfType` и прямые ссылки на конкретные классы.
- Способы снизить связанность: интерфейсы, события, DI, посредник, ScriptableObject-каналы.
- Как оценить связанность (afferent/efferent зависимости, лёгкость подмены в тесте).
