...
Сериализация, Inspector, drag-and-drop, `[Inject]` в [DI](di.md)/Zenject, тест-раннер, многие редакторные инструменты используют рефлексию и атрибуты. Senior понимает, что «магия» Inspector'а и DI — это чтение атрибутов рефлексией, и что это стоит производительности на старте.
