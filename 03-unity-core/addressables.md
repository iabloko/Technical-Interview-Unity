...
Addressables считают ссылки на каждый ассет/бандл. Загрузка увеличивает счётчик, `Release` — уменьшает. Бандл выгружается из памяти, когда счётчик дошёл до нуля.
...
- Двойной `Release` — ошибка (счётчик уходит в минус).
...
- Контент собирается отдельно: **Build → New Build → Default Build Script**; при изменении адресных ассетов нужна пересборка контента (иначе рассинхрон с каталогом).
