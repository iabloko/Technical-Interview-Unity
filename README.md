...
- [VContainer (и сравнение с Zenject)](02-architecture/di-vcontainer.md)
- [Clean Architecture: слои Domain / Application / Presentation](02-architecture/clean-architecture.md)
...
- [Конвенции C# / Unity и best practices MonoBehaviour](03-unity-core/conventions.md)
- [Система анимации: Animator, Blend Trees, Playables, IK](03-unity-core/animation.md)
- [Input System (новый) vs legacy Input](03-unity-core/input-system.md)
...
- [Кастомный рендеринг в URP: Renderer Features, compute shaders](04-rendering/urp-custom-rendering.md)
...
- [Orchestrator (координатор use-case)](08-patterns/orchestrator.md)
...
- [UniRx / R3 (реактивное программирование)](11-tools/unirx.md)
- [Editor scripting (расширения редактора)](11-tools/editor-scripting.md)
